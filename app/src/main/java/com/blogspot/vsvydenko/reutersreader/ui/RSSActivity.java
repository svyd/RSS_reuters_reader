...
public class RSSActivity extends Activity implements ActionBar.TabListener {
    ...
    private List<Fragment> getFragments(){
        ...
        fragmentList.add(FeedsListFragment.newInstance(FeedsListFragment.BUSINESS_NEWS_FRAGMENT));
        fragmentList.add(FeedsListFragment.newInstance(FeedsListFragment.ENTERTAITMENT_NEWS_FRAGMENT));
