...
public class XMLParser {
    ...
    public List<FeedItem> parse(String xml) throws XmlPullParserException, IOException {
    ...
    private List<FeedItem> readChannel(XmlPullParser parser) throws IOException, XmlPullParserException {
        List<FeedItem> items = new LinkedList<FeedItem>();
    ...
    // For the tags title, link and description, extracts their text values.
